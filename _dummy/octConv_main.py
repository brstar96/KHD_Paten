# https://github.com/jfzhang95/pytorch-deeplab-xception 참고해서 수정중
import argparse
import os
import numpy as np
...
class Trainer(object):
    ...
    def training(self, epoch):
        ...
        for i, sample in enumerate(tbar):
            ...
            # print('shape of target : ', output.shape)
            #
...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='TWDNE_Poly',
                        choices=['TWDNE_Poly', 'TWDNE_Pixel'],
    ...
    args.cuda = not args.no_cuda and torch.cuda.is_available() # True
    ...
    for epoch in range(trainer.args.start_epoch, trainer.args.epochs):
        ...
        if not trainer.args.no_val and epoch % args.eval_interval == (args.eval_interval - 1):
            ...
            # print('validation function skipped.')
