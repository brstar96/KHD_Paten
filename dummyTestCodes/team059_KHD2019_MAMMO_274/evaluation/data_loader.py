...
def feed_infer(output_file, infer_func):
    ...
    # result = []
    # for batch_num in range(len(data)//8+1):
    #     print("test_batch")
    #     if batch_num==len(data)//8:
    #         batch_data = data[batch_num*8:-1]
    #         result.append(infer_func(batch_data))
    #     else:
    #         batch_data = data[batch_num*8:batch_num*8+8]
    #         result.append(infer_func(batch_data))
